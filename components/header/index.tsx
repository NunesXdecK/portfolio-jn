                    ...
                    <div className="flex flex-row justify-between items-center px-4">
                        ...
                        <div className="flex flex-row items-center">
                            ...
                            <SwitchButton
                                ...
                                contentOn={(<Image width={wh} height={wh} className="rounded-full" alt="/../alt-image.png" src="/../public/usa-flag.png" />)}
                                contentOff={(<Image width={wh} height={wh} className="rounded-full" alt="/../alt-image.png" src="/../public/br-flag.png" />)}
                            />
                        </div>
                    </div>
                </Container>
